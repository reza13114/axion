...
// Mon Nov  3 17:10:52 2025 by ROOT version 6.22/06
// from TChain Delphes/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 740;
   static constexpr Int_t kMaxGenVertex = 38;
   static constexpr Int_t kMaxTrack = 107;
   static constexpr Int_t kMaxTower = 168;
   static constexpr Int_t kMaxEFlowTrack = 106;
   static constexpr Int_t kMaxEFlowPhoton = 83;
   static constexpr Int_t kMaxEFlowNeutralHadron = 42;
   static constexpr Int_t kMaxParticleFlowCandidate = 182;
   static constexpr Int_t kMaxCaloPhoton = 83;
   static constexpr Int_t kMaxPhotonEff = 38;
   static constexpr Int_t kMaxPhotonIso = 38;
   static constexpr Int_t kMaxGenJet = 5;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxJet = 5;
   static constexpr Int_t kMaxElectron = 6;
   static constexpr Int_t kMaxPhoton = 38;
   static constexpr Int_t kMaxMuon = 6;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/hz_background/Events/bkg_hz1.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/hz_background/Events/bkg_hz2.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/hz_background/Events/bkg_hz3.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/hz_background/Events/bkg_hz4.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/l_background/Events/bkg_ll.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/ta_background/Events/bkg_tautau.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/w_background/Events/bkg_ww1.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/w_background/Events/bkg_ww2.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/z_background/Events/bkg_zz1.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/z_background/Events/bkg_zz2.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/t_background/Events/bkg_tt1.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/t_background/Events/bkg_tt2.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/t_background/Events/bkg_tt3.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/t_background/Events/bkg_tt4.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/za_background/Events/bkg_za.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/bkg_jets/bkg_jets1.root/Delphes");
      chain->Add("/cmsdata4/haghighat/axion/MG5_aMC_v2_6_7/bkg_jets/bkg_jets2.root/Delphes");
      tree = chain;
#endif // SINGLE_TREE
